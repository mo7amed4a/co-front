  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid lg:grid-cols-2 grid-cols-1">
      ...
      <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl order-1 lg:order-2">
        ...
        <button className="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-indigo-800 bg-primary shadow-sm">Send</button>
      </div>
    </div>
  </div></section>
