...
export default async function page() {
  ...
  const {footer}:{footer: FooterType} = res.data.data
      ...
      <div className="lg:mb-0 mb-10 order-2 lg:order-1">
        <div className="group w-full h-full">
          <div className="relative h-full">
                <img src="https://pagedone.io/asset/uploads/1696488602.png" alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-primary object-cover" />
                ...
                <div className="bg-white rounded-lg p-6 block">
                    <a href={`tel:${footer?.contact_links?.phone}`} className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">{footer?.contact_links?.phone}</h5>
                    </a>
                    <a href={`mailto:${footer?.contact_links?.email}`} className="flex items-center mb-6">
                    <svg width={30} height={30} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 className="text-black text-base font-normal leading-6 ml-5">{footer?.contact_links?.email}</h5>
                    </a>
                    <span className="flex items-center">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">{footer?.contact_links?.address}</h5>
                    </span>
                </div>
                </div>
          </div>
