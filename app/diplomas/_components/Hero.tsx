        ...
        <div className="flex flex-col items-center justify-between xl:flex-row">
          <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
              Diplomas <br className="hidden md:block" />
              This is page all diplomas
            </h2>
          ...
          <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
            <div className="bg-white dark:bg-gray-700 rounded shadow-2xl flex flex-col items-center justify-center p-7 sm:p-10">
              ...
              <h3 className="mb-4 text-xl font-semibold sm:text-center sm:mb-6 sm:text-2xl flex items-center gap-3">
                Book Now
