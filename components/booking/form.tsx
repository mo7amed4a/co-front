  ...
  return (
    <main className="w-full">
      <form onSubmit={formik.handleSubmit}>
        <div className={`grid gap-8 pt-6 ${diploma ? "" : "sm:grid-cols-2"}`}>
          <div>
            <Input
              name="name"
              placeholder="Your Name"
              className="min-w-[180px] h-11  text-primary font-medium rounded-none"
          ...
          {diploma?.documentId === undefined && (
            <div>
              ...
              >
                <SelectTrigger className="min-w-[180px] h-11  text-primary font-medium">
