  ...
  <div className="mt-auto w-full max-w-7xl py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      <div className="col-span-full lg:col-span-2">
        ...
        <p className='text-white'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur voluptatem doloribus debitis expedita quia delectus placeat cupiditate veniam, sunt dolore.</p>
      </div>
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          ...
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Careers</a> <span className="inline ms-1 text-xs bg-cyan${c700} text-white py-1 px-2 rounded-lg">We&apos;re hiring</span></p>
    ...
    <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-400">© 2022 AUI. All rights reserved.</p>
      </div>
      <div>
        <a className="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-cyan-600/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">
